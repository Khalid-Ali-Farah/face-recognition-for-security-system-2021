...
![example](example.png)
![Alt text]([path/to/image](https://github.com/Khalid-Ali-Farah/face-recognition-for-security-system-2021/blob/main/Face%20Recognition%20(For%20Security%20System)/example.png?raw=true))
